...
class TestGetFileUrl:
    ...
    def test_get_file_url_no_pdf(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"data": {"itemType": "journalArticle"}}
        mock_get.return_value = mock_response
...
class TestHasPdf:
    ...
    def test_has_pdf_child_attachment(self):
        ...
        data = {
            "itemType": "journalArticle",
            "children": [{"itemType": "attachment", "contentType": "application/pdf"}],
        }
        assert client._has_pdf(data) is True
...
class TestParseItemToDocument:
    ...
    def test_parse_without_pdf(self):
        ...
        item = {
            "data": {"itemType": "journalArticle", "title": "Test Paper"},
            "key": "ITEM123",
        }
...
class TestGetDocumentsWithPdfs:
    ...
    def test_yields_documents_with_pdfs(
        self, mock_parse, mock_get_all, mock_get_group_ids
    ):
        """Test yielding documents with PDFs."""
        # Setup mocks
        mock_get_all.return_value = iter(
            [{"key": "item1", "data": {}}, {"key": "item2", "data": {}}]
        )
